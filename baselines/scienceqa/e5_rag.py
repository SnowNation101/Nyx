...
# # Indexing lectures
# if not os.path.exists(f"{index_dir}/e5_lecture.faiss"):
#     embeddings = []
...
# else:
#     lecture_index = faiss.read_index(f"{index_dir}/e5_lecture.faiss")
#     print(f"Lecture index loaded from {index_dir}/e5_lecture.faiss")

# # Indexing example QAs
# if not os.path.exists(f"{index_dir}/e5_example_qa.faiss"):
#     embeddings = []
...
# else:
#     example_qa_index = faiss.read_index(f"{index_dir}/e5_example_qa.faiss")
#     print(f"Example QA index loaded from {index_dir}/e5_example_qa.faiss")
...
#     with torch.no_grad():
#         query_embedding = average_pool(model(**batch_dict).last_hidden_state, batch_dict['attention_mask']).float().cpu().numpy()
